...
$noun           = array('design', 'Information Architecture', 'experience', 'blueprint', 'solution', 'problem', 'stakeholder', 'designer', 'idea', 'facts', 'Virtual Reality', 'research', 'personas', 'process', 'brand', 'visuals', 'wireframe', 'sketch', 'service', 'user journey', 'channel', 'social media', 'medium', 'web', 'app', 'technology', 'business', 'blockchain', 'IoT', 'Artificial Intelligence', 'Network', 'product', 'tools', 'ecosystem', 'system', 'dream', 'faith', 'gut feeling', 'hunch', 'app', 'platform', 'marketing', 'engagement', 'strategy', 'leadership', 'choice', 'thing', 'computer', 'smartphone', 'device', 'taxonomy');
